...
function FileterModal(props) {
  const handle_input_change = (event) => {
    const { name, value } = event.target;
    props.setFilterForm((prevState) => ({
      ...prevState,
      [name]: value,
    }));
  };
        ...
        <div className="relative w-auto my-6 mx-auto max-w-3xl">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gradient-to-r from-rose-700 to-red-700 outline-none focus:outline-none">
            ...
            <div className="flex items-start justify-between p-5 border-b border-solid border-blueGray-200 rounded-t">
              <h3 className="text-2xl font-semibold">Select Filters</h3>
              <button
            ...
            <div className="relative p-6 flex-auto">
              ...
              >
                ...
                <select
                  ...
                  name="experience"
                  value={props.filterForm.experience}
                ...
                <label className="text-lg font-semibold">Looking For</label>
                <select
                  className="border-2 border-border-blue-500 rounded-md p-2 mb-2"
                  name="lookingType"
                  value={props.filterForm.lookingType}
                  onChange={handle_input_change}
                >
                  <option value="">No Filter</option>
